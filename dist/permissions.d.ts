...
/** Permissões de todos os apps (shape do /api/membership): appSlug → ResourcePerms. */
export type PermsByApp = Record<string, ResourcePerms>;
/**
 ...
 */
export declare function can(perms: ResourcePerms | null | undefined, resourceSlug: string, action: PermActionLower): boolean;
/** Variante para o shape completo por app (ex.: resposta de /api/membership). */
export declare function canInApp(perms: PermsByApp | null | undefined, appSlug: string, resourceSlug: string, action: PermActionLower): boolean;
/** O membro tem alguma permissão no recurso? (útil pra esconder menus) */
export declare function canSee(perms: ResourcePerms | null | undefined, resourceSlug: string): boolean;
