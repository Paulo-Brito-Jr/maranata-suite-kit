 ...
 */
export function can(
  perms: ResourcePerms | null | undefined,
  resourceSlug: string,
  action: PermActionLower,
): boolean {
...
export function canInApp(
  perms: PermsByApp | null | undefined,
  appSlug: string,
  resourceSlug: string,
  action: PermActionLower,
): boolean {
...
export function canSee(perms: ResourcePerms | null | undefined, resourceSlug: string): boolean {
